...
import type { BlockParams, LogParams, TransactionReceiptParams, TransactionResponseParams, EtxParams, ExternalTransactionResponseParams, OutpointResponseParams, OutpointDeltaResponseParams } from './formatting.js';
...
export declare function formatTransactionResponse(value: any): TransactionResponseParams | ExternalTransactionResponseParams;
export declare function formatExternalTransactionResponse(value: any): ExternalTransactionResponseParams;
export declare function formatOutpoints(outpoints: OutpointResponseParams[]): Outpoint[];
export declare function formatOutpointDeltas(deltas: OutpointDeltaResponseParams): OutpointDeltas;
