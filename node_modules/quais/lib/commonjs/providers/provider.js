...
exports.getZoneFromEventFilter = exports.QiTransactionResponse = exports.QuaiTransactionResponse = exports.ExternalTransactionResponse = exports.TransactionReceipt = exports.zoneFromHash = exports.Log = exports.Block = exports.Uncle = exports.BlockHeader = exports.copyRequest = exports.addressFromTransactionRequest = exports.FeeData = void 0;
...
function addressFromTransactionRequest(tx) {
    if ('from' in tx && !!tx.from) {
        if (tx.from !== index_js_4.ZeroAddress) {
            return tx.from;
        }
    }
    if ('to' in tx && !!tx.to) {
        if (tx.to !== index_js_4.ZeroAddress) {
            return tx.to;
        }
    }
    if ('txInputs' in tx && !!tx.txInputs) {
        const inputs = tx.txInputs;
        return (0, index_js_2.computeAddress)(inputs[0].pubkey);
    }
...
exports.addressFromTransactionRequest = addressFromTransactionRequest;
/**
...
function copyRequest(req) {
    ...
    if ('accessList' in req && req.accessList) {
        result.accessList = (0, index_js_3.accessListify)(req.accessList);
    }
    if ('blockTag' in req) {
...
function zoneFromHash(hash) {
    return (0, index_js_4.toZone)(hash.slice(0, 4));
}
exports.zoneFromHash = zoneFromHash;
/**
...
class TransactionReceipt {
    ...
    async confirmations() {
        ...
        return (await this.provider.getBlockNumber((0, index_js_4.toShard)(zone))) - this.blockNumber + 1;
    }
    /**
     * @ignore
     */
...
exports.ExternalTransactionResponse = ExternalTransactionResponse;
/**
    ...
    async confirmations() {
        ...
        if (this.blockNumber == null) {
            const { tx, blockNumber } = await (0, index_js_1.resolveProperties)({
                ...
                blockNumber: this.provider.getBlockNumber((0, index_js_4.toShard)(zone)),
            });
            // Not mined yet...
        ...
        const blockNumber = await this.provider.getBlockNumber((0, index_js_4.toShard)(zone));
    ...
    async wait(_confirms, _timeout) {
        ...
        const checkReplacement = async () => {
            ...
            while (nextScan <= blockNumber) {
                ...
                const block = await this.provider.getBlock((0, index_js_4.toShard)(zone), nextScan, true);
...
exports.QuaiTransactionResponse = QuaiTransactionResponse;
/**
...
exports.QiTransactionResponse = QiTransactionResponse;
...
function getZoneFromEventFilter(filter) {
    ...
    if (filter.nodeLocation) {
        ...
        const addressZone = (0, shards_js_1.getZoneForAddress)(address);
        if (addressZone) {
            zone = (0, index_js_4.toZone)(addressZone);
        }
        else {
            return null;
        }
...
exports.getZoneFromEventFilter = getZoneFromEventFilter;
