...
exports.AbstractHDWallet = exports._guard = exports.MAX_ADDRESS_DERIVATION_ATTEMPTS = exports.HARDENED_OFFSET = void 0;
...
class AbstractHDWallet {
    ...
    constructor(guard, root, provider) {
        (0, index_js_2.assertPrivate)(guard, exports._guard, 'AbstractHDWallet');
        this._root = root;
    ...
    isValidAddressForZone(address, zone) {
        ...
        const isCorrectLedger = this.coinType() === 969 ? (0, index_js_3.isQiAddress)(address) : !(0, index_js_3.isQiAddress)(address);
    ...
    static createInstance(mnemonic) {
        ...
        const root = hdnodewallet_js_1.HDNodeWallet.fromMnemonic(mnemonic, this.parentPath(coinType));
        return new this(exports._guard, root);
    }
    /**
     ...
     */
    validateZone(zone) {
        if (!Object.values(index_js_4.Zone).includes(zone)) {
    ...
    validateBaseAddressInfo(info) {
        ...
        if (!Object.values(index_js_4.Zone).includes(info.zone)) {
...
exports.AbstractHDWallet = AbstractHDWallet;
